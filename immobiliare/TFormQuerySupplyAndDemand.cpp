...
void __fastcall TFormQuerySupplyAndDemand::Setup()
{
	this->Caption = AnsiString(APPNAME)
    	+ " - Incontro tra domanda ed offerta di beni immobili";
	...
	this->LabelAssets->Caption =
    	"Double Click on listed items for details";
	this->LabelCustomers->Caption =
    	"Click on listed items for Assets Query, Double Click for details";
